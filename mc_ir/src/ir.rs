...
impl<'a> Op<'a> {
  pub fn ty(&self) -> Option<Ty> {
    match self {
      ...
      Self::Gt(arg, _) => arg.ty(),
      Self::Gte(arg, _) => arg.ty(),
      Self::Lt(arg, _) => arg.ty(),
      Self::Lte(arg, _) => arg.ty(),
      ...
      Self::Not(arg) => arg.ty(),
      Self::Eq(arg, _) => arg.ty(),
      Self::Neq(arg, _) => arg.ty(),
      Self::Land(arg, _) => arg.ty(),
      Self::Lor(arg, _) => arg.ty(),
